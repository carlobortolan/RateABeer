...
> __NOTE__: _At the moment_ [___https://ticktack.onrender.com___](https://ticktack.onrender.com) _hosts the API and_ [___https://ticktack.onrender.com___](https://ticktack.onrender.com) _hosts the Frontend. You can find the docker-repository for the Frontend-image at_ `docker.io/carlobortolan/ticktack:frontend`.
